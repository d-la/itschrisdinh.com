<footer class="content-info mt-36 mb-8 max-w-7xl mx-auto px-5 <?php echo e($footerClasses); ?>">
  ...
  <div class="relative mx-auto w-full flex flex-row justify-between items-center text-white space-y-0">
    <?php if($phoneNumber): ?>
      <div class="footer-phoneumber w-full md:w-auto flex items-center">
        <a href="tel:<?php echo e($phoneNumber); ?>" class="flex items-center justify-center transition-transform duration-300 ease-in-out hover:scale-110 focus-within:scale-110 focus:scale-110 text-base">
            ...
            <span class="hidden md:block"><?php echo e($phoneNumber); ?></span>
        </a>
      </div>
    <?php endif; ?>

    <?php if($instagramLink['url']): ?>
      <div class="footer-instagram-link relative md:absolute md:left-1/2 md:transform md:-translate-x-1/2 text-center flex items-center">
        <a href="<?php echo e($instagramLink['url']); ?>" target="_blank" aria-label="Open Instagram link" class="flex items-center justify-center transition-transform duration-300 ease-in-out hover:scale-110 focus-within:scale-110 focus:scale-110 text-base">
    ...
    <?php if($emailAddress): ?>
      <div class="footer-email-address w-full md:w-auto flex items-center justify-end ml-auto">
        <a href="mailto:<?php echo e($emailAddress); ?>" class="flex items-center justify-center transition-transform duration-300 ease-in-out hover:scale-110 focus-within:scale-110 focus:scale-110 text-base">
          ...
          <span class="hidden md:block"><?php echo e($emailAddress); ?></span>
        </a>
      </div>
    <?php endif; ?>
  </div>
</footer>
<?php /**PATH /Users/daniel/Local Sites/itschrisdinh-2/app/public/wp-content/themes/itschrisdinh/resources/views/sections/footer.blade.php ENDPATH**/ ?>