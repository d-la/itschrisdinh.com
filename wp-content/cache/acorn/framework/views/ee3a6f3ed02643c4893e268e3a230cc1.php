<splide-slider
  ...
  >
    <div class="flex justify-center items-center">
        ...
        <div class="splide__custom-pagination text-center bottom-24 left-0 px-0 py-4 absolute right-0 z-1 text-white text-base <?php echo e($customPaginationShowOn); ?>"></div>
