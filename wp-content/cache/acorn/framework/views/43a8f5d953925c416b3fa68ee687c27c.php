...
<html <?php (language_attributes()); ?>>
  <head>
    ...
    <?php echo app('Illuminate\Foundation\Vite')(['resources/css/app.css', 'resources/js/app.js', 'resources/js/slider.js', 'resources/js/gallery-collections.js', 'resources/js/image-gallery.js', 'resources/js/image-gallery-lightbox.js']); ?>
  </head>
