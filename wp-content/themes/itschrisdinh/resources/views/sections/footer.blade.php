  ...
  <div class="relative mx-auto w-full flex flex-row justify-between items-center text-white space-y-0">
    ...
    @if ($instagramLink)
      <div class="footer-instagram-link relative md:absolute md:left-1/2 md:transform md:-translate-x-1/2 text-center flex items-center">
        <a href="{{ $instagramLink }}" target="_blank" aria-label="Open Instagram link" class="flex items-center justify-center transition-transform duration-300 ease-in-out hover:scale-110 focus-within:scale-110 focus:scale-110 text-base">
